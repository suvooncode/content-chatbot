    ...
    TynApp.Chat = {
      ...
      botsend:function(){
        ...
        chatSend && chatSend.addEventListener("click", function(event){
          ...
          $("#tynBotSend").hide();
          $(".loader").show(500);
          let responseTxt =  "Looks like not relavant for now!";
          let refFIles="No file";
          $.ajax({
              url: `${config.URL}/Chat?question=${getInput}`,
              type: 'GET',
              headers: {
              ...
              error: function(xhr, status, error) {
                responseTxt = "Looks like not relatable."
                refFIles="No file";
              }
          });
          chatInput.innerHTML = "";
